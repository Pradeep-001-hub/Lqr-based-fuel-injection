...
This work presents a linearized mathematical model of a fuel injection system and applies an LQR controller to regulate the air-fuel ratio to the desired stoichiometric value (14.7) with optimal control effort.